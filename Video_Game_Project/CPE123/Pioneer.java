...
**/
public class Pioneer extends Enemy
{
   private int health;
   ...
   //Arya
   public Pioneer(int health){
       super(health);
       for(int i=0; i < 12; i++) {
            Animation[i] = new GreenfootImage("merctwo" + i + ".png");
        }
   }
   //Arya  
   public void act(){
   ...
   public boolean onGround(){
       Actor under = getOneObjectAtOffset(0 , 40, Tile.class); 
       return under != null; 
   }
   //Arya
   public void gravity(){
